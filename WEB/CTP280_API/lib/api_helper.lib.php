...
class ApiHelper 
{
  ...
  public function logApiCall($table_name, $gubun, $machine_no, $mac, $request_data, $response_data, $reg_date) 
  {
    try {
      ...
      $allowed_tables = [
        'logs_api_start', 'logs_api_get_andonlist', 'logs_api_get_downtimelist', 
        'logs_api_get_defectivelist', 'logs_api_get_datetime', 'logs_api_send_andon_warning', 
        'logs_api_send_andon_completed', 'logs_api_send_downtime_warning', 
        'logs_api_send_downtime_completed', 'logs_api_send_defective_warning', 'logs_api_send_pCount'
      ];
