...
if ($oee_data) {
  if ($is_reset) {
    ...
    $stmt->execute([
      ...
      $oee_metrics['target_line_per_day'], $oee_metrics['target_line_per_hour'], $oee_metrics['target_mc_per_day'],
      $oee_metrics['target_mc_per_hour'], $oee_metrics['cycletime'], $pair_info, $pair_count,
