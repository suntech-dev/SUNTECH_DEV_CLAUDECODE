  ...
  <div class="fiori-app-bar__container">
    ...
    <ul class="fiori-nav-menu">
      ...
      <li class="fiori-nav-menu__item <?php echo ($current_page == 'dashboard.php') ? 'fiori-nav-menu__item--active' : ''; ?>">
        <a href="<?php echo $data_base_path; ?>/dashboard.php" class="fiori-nav-menu__link">
          Dashboard
        </a>
      </li>

      <!-- AI (단독) -->
      <!-- <li class="fiori-nav-menu__item <?php echo ($current_page == 'report.php') ? 'fiori-nav-menu__item--active' : ''; ?>">
        <a href="<?php echo $data_base_path; ?>/report.php" class="fiori-nav-menu__link" >
          AI Report (only layout)
        </a>
      </li> -->
