...
$page_css_files = ['../../assets/css/fiori-page.css', 'css/info_downtime.css'];
...
?>
  ...
  <div class="fiori-container">
    <main>
      ...
      <div class="factory-stats-grid" id="statsGrid" style="display: none;">
        ...
        <!-- Dynamic downtime warning cards will be inserted here -->
      </div>
        ...
        <div class="fiori-card">
          ...
          <div class="fiori-card__content fiori-p-0">
            ...
            <div id="noDataMessage" class="text-center" style="padding: var(--sap-spacing-xl); color: var(--sap-text-secondary); display: none;">
              <p>There are no downtimes matching your search criteria.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form id="resourceForm" class="fiori-form">
            ...
            <div class="form-section" data-section="2" style="display: none;">
              ...
              <div class="fiori-form__group">
                ...
                <div class="fiori-form__help">You can record downtime information.</div>
              </div>              
            ...
            <div class="fiori-form__actions">
              ...
              <button type="submit" class="fiori-btn fiori-btn--primary" id="submitBtn" style="display: none;">💾 Save Downtime</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="module">
    ...
    import { initAdvancedFeatures, downtimeConfig } from './js/info_downtime.js';
    import { initStatsToggle } from '../../assets/js/manage/stats-toggle.js';

    let resourceManager;

    document.addEventListener('DOMContentLoaded', function() {
      resourceManager = createResourceManager(downtimeConfig);
      setTimeout(() => {
