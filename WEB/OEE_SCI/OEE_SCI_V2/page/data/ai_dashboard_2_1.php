...
<div class="ai-signage-main">
    ...
    <div class="ai-signage-row-d">
        ...
        <div class="fiori-card">
            <div class="fiori-card__header">
                <div class="card-title-row">
                    ...
                    <span class="card-subtitle-inline fiori-text-secondary">By duration (min) · filter period</span>
                </div>
            </div>
            <div class="fiori-card__content">
        ...
        <div class="fiori-card">
            <div class="fiori-card__header">
                <div class="card-title-row">
                    <h3 class="fiori-card__title fiori-text-primary">Defective Top 5</h3>
                    <span class="card-subtitle-inline fiori-text-secondary">By count · filter period</span>
                </div>
            </div>
            <div class="fiori-card__content">
                <div class="ai-top5-chart-wrap">
