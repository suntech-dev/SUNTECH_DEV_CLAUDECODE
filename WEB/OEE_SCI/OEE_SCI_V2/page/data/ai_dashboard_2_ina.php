...
/*
 * ============================================================
 * 파일명  : ai_dashboard_2_ina.php
 * 목  적  : 1920×1080 사이니지(Signage) 전용 AI 인텔리전스 대시보드 (인도네시아어 버전)
 *           AI 기반 OEE 예측, 이상 감지(Anomaly Detection), 예측 정비,
 *           생산 최적화(Production Optimization) 정보를 한 화면에 표시한다.
 * 원본    : ai_dashboard_2.php
 * 연관 파일:
 *   - css/ai_dashboard_2.css      : 사이니지 AI 대시보드 스타일
 *   - js/ai_dashboard_2_ina.js    : AI 차트·카드 렌더링 로직 (인도네시아어)
 *   - js/ai_optimization_2_ina.js : 생산 최적화 분석 렌더링 로직 (인도네시아어)
 *   - js/ai_stream_monitor_2_ina.js : AI 스트림 모니터 (인도네시아어)
...
// 브라우저 탭 및 페이지 제목 설정
$page_title = 'AI Intelligence Dashboard - Signage (INA)';
        ...
        <div class="fiori-card">
            <div class="fiori-card__header">
                <div class="card-title-row">
                    ...
                    <span class="card-subtitle-inline fiori-text-secondary">Analisis bottleneck OEE · Peluang perbaikan (periode berdasarkan filter)</span>
                </div>
            ...
            <div class="fiori-card__content">
                <div id="aiOptList" class="ai-opt-list">
                    <div class="ai-empty-state">
                        <span class="ai-spinner"></span> Menganalisis peluang optimasi...
                    </div>
                </div>
            </div>
        </div>
...
<!-- loadPrediction() 오버라이드 — ai_oee_prediction_dash_2.php 호출 -->
<script>
    (function() {
