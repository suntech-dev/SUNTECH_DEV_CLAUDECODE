...
/**
 * ai_dashboard_5.php — 1920x1080 Signage AI Dashboard (v5)
 ...
 *
 * 연관 파일 (_5 버전):
 *  - css/ai_dashboard_5.css
 *  - js/ai_dashboard_5.js
 *  - js/ai_optimization_5.js
 *  - proc/ai_oee_prediction_5.php
 *  - proc/ai_maintenance_5.php
 *  - proc/ai_optimization_5.php
 */

$page_title = 'AI Intelligence Dashboard v5 - Signage';
$page_css_files = [
    ...
    <div class="fiori-card">
      <div class="fiori-card__header">
        <div class="card-title-row">
          ...
          <!-- v5: .ai-health-subtitle 는 JS 에서 date_range 에 맞게 동적으로 업데이트 -->
    ...
    <div class="fiori-card">
      <div class="fiori-card__header">
        <div class="card-title-row">
          ...
          <!-- v5: 분석 기간이 date_range 에 따라 달라짐을 명시 -->
...
<!-- AI Dashboard v5 JS -->
<script src="js/ai_dashboard_5.js"></script>
<script src="js/ai_stream_monitor.js"></script>
<script src="js/ai_optimization_5.js"></script>
...
<!-- v5: loadPrediction() 오버라이드 — ai_oee_prediction_5.php 호출 -->
<script>
  (function() {
