<?php
/**
 * OEE Hourly Data Log Excel Export API
 *
 * Features:
 * - Excel export with all columns from data_oee_rows_hourly table
...
function parseFilterParams() {
  ...
  if (empty($_GET['start_date']) && empty($_GET['end_date'])) {
    $where_clauses[] = 'doh.work_date = CURDATE()';
  }
...
/**
 * Export OEE hourly data log to Excel
 */
function exportOeeHourlyDataLog(PDO $pdo) {
  try {
    ...
    $sheet->setTitle('OEE Hourly Data Log');
