<?php
/**
 * AI Predictive Maintenance API v5
 * v4 대비 수정:
...
if ($factory_filter !== '') { $where_parts[] = 'im.factory_idx = ?'; $params[] = $factory_filter; }
if ($line_filter    !== '') { $where_parts[] = 'im.line_idx = ?';    $params[] = $line_filter; }
if ($machine_filter !== '') { $where_parts[] = 'im.idx = ?';         $params[] = $machine_filter; }
