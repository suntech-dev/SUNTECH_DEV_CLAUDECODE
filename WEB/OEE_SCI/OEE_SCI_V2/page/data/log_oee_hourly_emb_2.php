<?php
$page_title = 'EMB Hourly Data Log';
$page_css_files = [
    '../../assets/css/fiori-page.css',
    '../../assets/css/daterangepicker.css',
    'css/log_oee_hourly_emb_2.css',
];
...
<div class="signage-header">
    ...
    <span class="signage-header__title">EMB Hourly Data Log</span>

    <div class="signage-header__filters">
        <?php include __DIR__ . '/inc/signage_filters.php'; ?>

        <div class="log-hourly-emb-dropdown">
            <button id="columnToggleBtn" class="fiori-btn fiori-btn--secondary">Columns</button>
            <div id="columnToggleDropdown" class="log-hourly-emb-dropdown__content"></div>
        </div>
...
<div class="log-hourly-emb-main" id="logHourlyEmbMain">

    <!-- Row A: Stats (기본 hidden) -->
    <div id="logHourlyEmbStats" class="log-hourly-emb-row log-hourly-emb-row--stats hidden">
    ...
    <!-- Row B: Table -->
    <div id="logHourlyEmbTable" class="log-hourly-emb-row log-hourly-emb-row--table">
        <div class="fiori-card">
            <div class="fiori-card__header">
                <h3 class="fiori-card__title">EMB Hourly Data Log</h3>
                            ...
                            <tr>
                                <td colspan="25" class="data-table-centered">
                                    <div class="fiori-alert fiori-alert--info">
                                        <strong>Information:</strong> Loading EMB hourly data log. Please wait...
                                    </div>
                                </td>
                            </tr>
                        </tbody>
    ...
    <!-- Row C: Pagination -->
    <div id="logHourlyEmbPagination" class="log-hourly-emb-row log-hourly-emb-row--pagination">
...
<script src="js/log_oee_hourly_emb_2.js"></script>
