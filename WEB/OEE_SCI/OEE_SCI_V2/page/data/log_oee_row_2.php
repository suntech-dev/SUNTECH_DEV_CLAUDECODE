<?php
$page_title = 'OEE Row Data Log';
$page_css_files = [
    '../../assets/css/fiori-page.css',
    '../../assets/css/daterangepicker.css',
    'css/log_oee_row_2.css',
];
...
<!-- Log OEE Row Signage Main -->
<div class="log-row-main" id="logRowMain">

    <!-- Row A: Stats (기본 hidden) -->
    <div id="logRowStats" class="log-row log-row--stats hidden">
    ...
    <!-- Row B: Table -->
    <div id="logRowTable" class="log-row log-row--table">
        <div class="fiori-card">
            <div class="fiori-card__header">
                <h3 class="fiori-card__title">OEE Row Data Log</h3>
    ...
    <!-- Row C: Pagination -->
    <div id="logRowPagination" class="log-row log-row--pagination">
...
<script src="js/log_oee_row_2.js"></script>
