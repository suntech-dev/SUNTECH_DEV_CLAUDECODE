...
/**
 * ai_dashboard_4.php — 1920x1080 Signage AI Dashboard (v4)
 * ai_dashboard_3.php 개선본
 * - Row A: 5카드 레이아웃 (Real-time OEE 신규 추가)
 *   · 카드1: Real-time OEE (현재 실제값 + LIVE 인디케이터)
 *   · 카드2: Next 4H AI Forecast (예측 평균값으로 수정)
 * - ai_dashboard.js 의 loadPrediction() 오버라이드로 두 카드 역할 분리
 */

$page_title = 'AI Intelligence Dashboard v4 - Signage';
$page_css_files = [
  '../../assets/css/fiori-page.css',
  'css/dashboard.css',
  'css/ai_dashboard.css',
  'css/ai_dashboard_4.css',
];
...
<div id="navDrawer" class="nav-drawer">
  ...
  <nav class="nav-drawer__menu">
    ...
    <a href="ai_dashboard_4.php" class="nav-drawer__link nav-drawer__link--active">AI Dashboard v4</a>
  </nav>
</div>
...
<div class="ai-signage-main">
  ...
  <!-- Row A: AI Summary 카드 5개 (v4: Real-time OEE 추가) -->
  <div class="ai-signage-row-a">
    <div class="ai-summary-grid">
      ...
      <!-- OEE AI 예측 (v4: 큰 값을 forecastAvg로 변경) -->
...
<!-- v4: loadPrediction() 오버라이드 — Real-time OEE 카드 + Forecast 카드 분리 -->
<script>
  (function() {
    // ai_dashboard.js 의 loadPrediction 을 덮어써서 두 카드를 독립적으로 채움
