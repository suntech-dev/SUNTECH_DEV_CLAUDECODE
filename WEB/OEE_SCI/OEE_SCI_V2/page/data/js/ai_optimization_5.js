/**
 * F13 — AI Production Optimization v5
 * v4(ai_optimization.js) 대비 수정:
 *  - API 엔드포인트: proc/ai_optimization.php → proc/ai_optimization_5.php
...
(function () {
  ...
  async function loadOptimization() {
    ...
    try {
      const res  = await fetch(`proc/ai_optimization_5.php${qs ? '?' + qs : ''}`);
      ...
      console.warn('[AI Optimization v5]', e);
  ...
  function renderSummary(s) {
    ...
    const dayLabel = s.analysis_days ? s.analysis_days + 'd' : '14d';
    el.innerHTML = `
