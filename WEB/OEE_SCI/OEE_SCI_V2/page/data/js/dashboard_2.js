...
class DashboardManager {
    ...
    connectToStream() {
        ...
        eventSource.onopen = () => {
            isConnected = true;
            this.updateConnectionStatus('Real-time data connected');
        };
        ...
        eventSource.onerror = () => {
            ...
            isConnected = false;
            this.updateConnectionStatus('Retrying connection...');
    ...
    updateConnectionStatus(message) {
        ...
        statusElements.forEach(el => {
            if (el.textContent.includes('connection') || el.textContent.includes('Retry')) {
