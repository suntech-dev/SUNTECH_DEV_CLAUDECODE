...
$page_css_files = ['../../assets/css/fiori-page.css', '../../assets/css/daterangepicker.css', 'css/data_defective.css', 'css/ai_dashboard.css'];
...
<div class="fiori-container">
  <main>
    ...
    <!-- AI Quality Sentinel                                        -->
    <!-- ============================================================ -->
    <div class="fiori-section" id="aiQualitySentinelSection">
      <div class="fiori-card">
        <div class="fiori-card__header">
          <div>
            ...
            <p class="fiori-card__subtitle">Pareto · 시간대 패턴 · 기계 위험 순위 · OEE 상관관계</p>
          </div>
          <div style="display:flex; align-items:center; gap:var(--sap-spacing-sm);">
            <span id="aiQsLastUpdate" style="font-size:0.75rem; color:var(--sap-text-secondary);">-</span>
            <button id="aiQsRefreshBtn" class="fiori-btn fiori-btn--tertiary" style="padding:4px 10px; font-size:0.75rem;">↻</button>
          </div>
        </div>
        <div class="fiori-card__content" style="padding:var(--sap-spacing-md);">

          <!-- 로딩 상태 -->
          <div id="aiQsLoading" class="ai-empty-state">
            <div class="ai-spinner"></div>
            <span>AI가 불량 패턴을 분석 중입니다...</span>
          </div>

          <!-- 분석 결과 (데이터 로드 후 표시) -->
          <div id="aiQsContent" style="display:none;">

            <!-- 요약 카드 4개 -->
            <div class="ai-summary-grid" id="aiQsSummaryGrid" style="margin-bottom:var(--sap-spacing-lg);"></div>

            <!-- Pareto + 시간대 히트맵 -->
            <div class="ai-main-grid" style="grid-template-columns:1fr 1fr; margin-bottom:var(--sap-spacing-lg);">

              <div class="fiori-card" style="border:1px solid var(--sap-border-neutral);">
                <div class="fiori-card__header">
                  <div>
                    <h4 class="fiori-card__title">Pareto 분석</h4>
                    <p class="fiori-card__subtitle" id="aiQsParetoSubtitle" style="font-size:0.75rem;">불량 유형별 빈도</p>
                  </div>
                </div>
                <div class="fiori-card__content" style="padding:var(--sap-spacing-md);">
                  <div style="position:relative; height:220px;">
                    <canvas id="aiQsParetoChart"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="fiori-card" style="border:1px solid var(--sap-border-neutral);">
                <div class="fiori-card__header">
                  <div>
                    <h4 class="fiori-card__title">시간대별 발생 빈도</h4>
                    <p class="fiori-card__subtitle" id="aiQsPeakHourText" style="font-size:0.75rem;">24시간 불량 집중 구간</p>
                  </div>
                </div>
                <div class="fiori-card__content" style="padding:var(--sap-spacing-md);">
                  <div id="aiQsHourlyHeatmap" class="ai-hourly-heatmap"></div>
                </div>
              </div>
            ...
            <div class="ai-bottom-grid">
              ...
              <div class="fiori-card" style="border:1px solid var(--sap-border-neutral);">
                <div class="fiori-card__header">
                  <h4 class="fiori-card__title">기계별 위험 순위</h4>
                </div>
                <div class="fiori-card__content" style="padding:var(--sap-spacing-md);">
                  <div id="aiQsMachineRanking" class="ai-maintenance-list"></div>
                </div>
              </div>

              <div class="fiori-card" style="border:1px solid var(--sap-border-neutral);">
                <div class="fiori-card__header">
                  <h4 class="fiori-card__title">불량 ↔ OEE 상관관계</h4>
                </div>
                <div class="fiori-card__content" style="padding:var(--sap-spacing-md);">
                  <div id="aiQsCorrelation"></div>
                </div>
              </div>
...
<script src="js/ai_quality_sentinel.js"></script>
