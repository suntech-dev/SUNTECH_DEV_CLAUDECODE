...
<div id="navDrawer" class="nav-drawer">
    ...
    <nav class="nav-drawer__menu">
        ...
        <div class="nav-drawer__group">
            ...
            <a href="<?= $_d ?>ai_dashboard_2_1.php" class="<?= _nav_cls('ai_dashboard', $_nav) ?>">AI Dashboard<span class="ai-badge">AI</span></a>
            <a href="<?= $_d ?>ai_dashboard_2_1_ina.php" class="<?= _nav_cls('ai_dashboard_ina', $_nav) ?>">AI Dashboard<span class="ai-badge">AI</span><span class="ina-badge">INA</span></a>
        </div>
        <div class="nav-drawer__divider"></div>
        <div class="nav-drawer__group">
