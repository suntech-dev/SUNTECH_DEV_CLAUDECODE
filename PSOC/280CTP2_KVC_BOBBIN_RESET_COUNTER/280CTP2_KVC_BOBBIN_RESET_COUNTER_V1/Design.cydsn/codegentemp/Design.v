...
module top ;
	...
	wire [0:0] tmpOE__RESET_KEY_net;
	wire [0:0] tmpFB_0__RESET_KEY_net;
	wire [0:0] tmpIO_0__RESET_KEY_net;
	wire [0:0] tmpINTERRUPT_0__RESET_KEY_net;
	electrical [0:0] tmpSIOVREF__RESET_KEY_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b4bc4555-8ffc-4bd0-ad4b-76728038b080"),
		  ...
		  .input_buffer_sel(2'b00))
		RESET_KEY
		 (.oe(tmpOE__RESET_KEY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESET_KEY_net[0:0]}),
		  .io({tmpIO_0__RESET_KEY_net[0:0]}),
		  .siovref(tmpSIOVREF__RESET_KEY_net),
		  .interrupt({tmpINTERRUPT_0__RESET_KEY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESET_KEY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__KEY_LOCK_net;
	wire [0:0] tmpFB_0__KEY_LOCK_net;
	wire [0:0] tmpIO_0__KEY_LOCK_net;
	wire [0:0] tmpINTERRUPT_0__KEY_LOCK_net;
	electrical [0:0] tmpSIOVREF__KEY_LOCK_net;

	cy_psoc3_pins_v1_10
		#(.id("66a4aeec-3fb2-480e-b981-c61bf11685d2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KEY_LOCK
		 (.oe(tmpOE__KEY_LOCK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KEY_LOCK_net[0:0]}),
		  .io({tmpIO_0__KEY_LOCK_net[0:0]}),
		  .siovref(tmpSIOVREF__KEY_LOCK_net),
		  .interrupt({tmpINTERRUPT_0__KEY_LOCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KEY_LOCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
