...
#define WIFI_COMP_VERSION_MAJOR    (4)
#define WIFI_COMP_VERSION_MINOR    (0)
...
*/
#define WIFI_SCB_SW_RESET   WIFI_I2CFwBlockReset()
...
#define WIFI_DISABLE_AUTO_DATA \
                do{                        \
                    WIFI_I2C_CTRL_REG &= ((uint32) ~(WIFI_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 WIFI_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 WIFI_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 WIFI_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define WIFI_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    WIFI_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    WIFI_UART_RX_CTRL_BREAK_WIDTH_MASK)
