        ...
        case PATTERN_MACHINE:
        {
            switch(page)
            {
                ...
                case 1:
                    ...
                    SetButtonText(&menu->btn[3],g_patternString[4]);  /* "MRT" */
                    SetButtonText(&menu->btn[5],g_patternString[5]);  /* "TB"  */
                    break;
            }
        }
        break;
...
{
    /* BLACK_CPU: PATTERN_MACHINE 고정 */
    SetDrawUpDownTwoMenu(menu, "Count", "Pair(s)", "Pairs info.");
...
{
    /* BLACK_CPU: PATTERN_MACHINE 고정 */
    return g_ptrMachineParameter->patternTarget;
}
