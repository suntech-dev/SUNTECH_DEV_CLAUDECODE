...
void DisplayDeviceInfoMenu()
{
    ...
    LCD_printf(xPos,yPos+30,WHITE,BLACK,SmallFont8x12,g_network.MAC);
...
void DisplayWifiInfoMenu()
{
    ...
    LCD_printf(xPos,yPos+30,WHITE,BLACK,SmallFont8x12,g_network.IPv4);
    LCD_printf(xPos,yPos+50,WHITE,BLACK,SmallFont8x12,g_network.Gateway);
    LCD_printf(xPos,yPos+70,WHITE,BLACK,SmallFont8x12,g_network.SubnetMask);             
}
