...
> 최초 작성: 2026-03-09
> 분석 버전: V1 (통합 IoT 재봉기 패턴 머신)
> 마지막 빌드: 2025-11-17 (성공)
> 마지막 코드 개선: 2025-10-15
> 마지막 업데이트: 2026-03-09
...
| 파일 | 경로 |
|------|------|
| 메인 로직 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/main.c` |
| ANDON API | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/andonApi.c` |
| ANDON JSON 파싱 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/andonJson.c` |
| WiFi 통신 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/lib/WIFI.c` |
| 서버 설정 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/lib/server.h` |
| 카운팅 로직 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/count.c` |
| 가동 중단 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/downtime.c` |
| 불량 관리 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/defective.c` |
| 외부 Flash | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/lib/externalFlash.c` |
| 내부 EEPROM | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/lib/internalFlash.c` |
| 프로젝트 타입 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/package.h` |
| 설정 구조체 | `280CTP_IoT_INTEGRATED_V1/Project/Design.cydsn/lib/config.h` |
| 설정 도구 | `280CTP_IoT_INTEGRATED_V1/SuntechIoTConfig_V1/MainForm.cs` |
