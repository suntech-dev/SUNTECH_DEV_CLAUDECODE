/***************************************************************************//**
* \file MONITORING_TABLET_UART_BOOT.c
* \version 4.0
*
* \brief
...
/*******************************************************************************
* Function Name: MONITORING_TABLET_UartCyBtldrCommStart
****************************************************************************//**
*
...
{
    MONITORING_TABLET_Start();
}


/*******************************************************************************
* Function Name: MONITORING_TABLET_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: MONITORING_TABLET_UartCyBtldrCommReset
****************************************************************************//**
*
...
void MONITORING_TABLET_UartCyBtldrCommReset(void)
{
    ...
    MONITORING_TABLET_SpiUartClearRxBuffer();
    MONITORING_TABLET_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: MONITORING_TABLET_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != MONITORING_TABLET_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = MONITORING_TABLET_SpiUartGetRxBufferSize();
                    CyDelayUs(MONITORING_TABLET_UART_BYTE_TO_BYTE);
                }
                while (byteCount != MONITORING_TABLET_SpiUartGetRxBufferSize());

                byteCount = MONITORING_TABLET_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(MONITORING_TABLET_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) MONITORING_TABLET_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: MONITORING_TABLET_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus MONITORING_TABLET_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        MONITORING_TABLET_SpiUartPutArray(pData, (uint32) size);
