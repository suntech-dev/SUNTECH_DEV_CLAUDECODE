...
/*******************************************************************************
* Function Name: MONITORING_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: MONITORING_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: MONITORING_UartCyBtldrCommReset
****************************************************************************//**
*
...
void MONITORING_UartCyBtldrCommReset(void)
{
    ...
    MONITORING_SpiUartClearRxBuffer();
    MONITORING_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: MONITORING_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != MONITORING_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = MONITORING_SpiUartGetRxBufferSize();
                    CyDelayUs(MONITORING_UART_BYTE_TO_BYTE);
                }
                while (byteCount != MONITORING_SpiUartGetRxBufferSize());

                byteCount = MONITORING_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) MONITORING_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: MONITORING_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus MONITORING_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        MONITORING_SpiUartPutArray(pData, (uint32) size);
