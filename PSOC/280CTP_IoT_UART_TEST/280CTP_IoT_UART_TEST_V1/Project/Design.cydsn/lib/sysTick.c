...
#define MAX_NO_MILISECOND_COUNTER  16u
...
// 1ms에 관련된 것들  //////////////////////////////////////////////
///////////////////////////////////////////////////////////////
static uint8 g_uNoMiliSecondCounter=0;                              /* sysTick.c 내부 전용 */
static TIMER_COUNTER g_timerCounter_1ms[MAX_NO_MILISECOND_COUNTER]; /* 접근자 함수로만 외부 접근 */
...
{
    g_timerCounter_1ms[index].current = 0;
...
uint16 getCurrentTimerCounter_1ms(uint16 index) { return g_timerCounter_1ms[index].current; }
